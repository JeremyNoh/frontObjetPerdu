Ce projet est créer en React Native pour l'installer / le lancer merci de suivre [Create React Native App](https://github.com/react-community/create-react-native-app).
